...
function _getCommitsFiles() {
  _getCommitsFiles = (0, _asyncToGenerator2["default"])(
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            ...
            case 6:
              ...
              responseCommit = _objectSpread(
                _objectSpread({}, dataCommitMaster),
                file
              );
...
function _getCommitsFile() {
  _getCommitsFile = (0, _asyncToGenerator2["default"])(
                              ...
                              while (1) {
                                switch ((_context2.prev = _context2.next)) {
                                  case 0:
                                    ...
                                    commitsList = [];
                                    count = -1;
                                    _context2.t0 = _regenerator["default"].keys(
                                      response.data
                                    );
                                  ...
                                  case 4:
                                    ...
                                    messageFeeling = textIsBadOrGood(
                                      data.commit.message
                                    ); //Covert string in lowcase

                                    //Covert string in lowcase
                                    bugWord = haveWoldOfBug(
                                      data.commit.message.toLowerCase()
                                    );
                                    dataCommitMaster = {
                                      shaCommit: data.sha,
                                      ...
                                      messageFeelingComparative:
                                        messageFeeling.comparative,
                                      urlCommit: data.commit.url.replace(
                                        "/git",
                                        ""
                                      ),
...
function _collectCommitsOfFiles() {
  _collectCommitsOfFiles = (0, _asyncToGenerator2["default"])(
