...
var _require = require('./model'),
    ...
    schemafilesHub = _require.schemafilesHub; // new
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            filesHubs = _context.sent;
            logger.info('Read all filesHub cases');
            res.send(filesHubs);
...
router.post('/', /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var filesHub, filesHub2;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return validateSchema(req.body, schemafilesHub);

          case 2:
            logger.warn(req.body);
            logger.info('save data: ' + JSON.stringify(req.body));
            _context2.next = 6;
            return new filesHub(req.body);

          case 6:
            filesHub = _context2.sent;
            _context2.next = 9;
            return filesHub.save();

          case 9:
            _context2.next = 11;
            return filesHub.findOne(filesHub);

          case 11:
            filesHub2 = _context2.sent;
            logger.info(filesHub2);
            _context2.next = 15;
            return res.send(filesHub2);
...
}()); // curl http://localhost:5000/api/filesHubs \
//     -X filesHub \
//     -H "Content-Type: application/json" \
//     -d '{"projectName":"filesHub 1", "context":"Lorem ipsum"}'

router.get('/filesHubs/:id', /*#__PURE__*/function () {
...
}()); // curl http://localhost:5000/api/filesHubs/<OBJECT_ID>
// curl http://localhost:5000/api/filesHubs/60ccf14b8e95302f0e99295f
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _filesHub.findOne({
              _id: req.params.id
            });

          case 3:
            _filesHub = _context4.sent;
            res.send(_filesHub);
            _context4.next = 11;
            break;
