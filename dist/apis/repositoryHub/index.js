...
var _require = require("./model"),
    repositoryHub = _require.repositoryHub,
    schemarepositoryHub = _require.schemarepositoryHub; // new
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return repositoryHub.find();

          case 4:
            repositoryHubs = _context.sent;
...
router.post("/", /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var repositoryHub, repositoryHub2;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return validateSchema(req.body, schemarepositoryHub);

          case 2:
            logger.warn(req.body);
            logger.info("save data: " + JSON.stringify(req.body));
            _context2.next = 6;
            return new repositoryHub(req.body);

          case 6:
            repositoryHub = _context2.sent;
            _context2.next = 9;
            return repositoryHub.save();

          case 9:
            _context2.next = 11;
            return repositoryHub.findOne(repositoryHub);

          case 11:
            repositoryHub2 = _context2.sent;
            logger.info(repositoryHub2);
            _context2.next = 15;
            return res.send(repositoryHub2);
...
router.get("/repositoryHubs/:id", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _repositoryHub.findOne({
              _id: req.params.id
            });

          case 3:
            _repositoryHub = _context4.sent;
            res.send(_repositoryHub);
            _context4.next = 11;
            break;
          ...
          case 7:
            ...
            res.status(404);
            res.send({
              error: "repositoryHub doesn't exist!"
            });
