...
app.get('/', (req, res) => {
  res.send(
    '<ol><li><a href="/auth/google">Authenticate with Google</a></li> <li><a href="/auth/facebook">Authenticate with Facebook</a></li> <li><a href="/auth/apple">Authenticate with Apple</a></li></ol>'
  );
});
